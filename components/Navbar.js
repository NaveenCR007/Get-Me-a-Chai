            ...
            <div>
                {session ? (
                    <div className="flex items-center gap-2 relative" ref={dropdownRef}>
                        ...
                        {dropDown && (
                            <div className="z-50 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 absolute top-14 right-0">
                                <ul className="py-2 text-sm text-gray-700 dark:text-gray-200">
                                    <li>
                                        <Link href="/dashboard" onClick={() => {setDropDown(false)}} className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Dashboard</Link>
                                    </li>
                                    <li>
                                        <Link href="/profile" onClick={() => {setDropDown(false)}} className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Your Profile</Link>
                                    </li>
                                    <li>
                                        <button
                                            onClick={() => signOut({ callbackUrl: "/" })}
                                            className="block cursor-pointer px-4 w-full text-left py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                                        >
                                            Sign out
                                        </button>
                                    </li>
